  ...
  <div class="home min-h-screen bg-black">
    ...
    >
      <div class="text-center">
        ...
        ></div>
        <p class="text-white text-lg">Loading movies...</p>
      </div>
    </div>
    ...
    <div v-else class="container mx-auto px-4 py-8 pt-24">
      <div class="search-section animate-fade-in-up mb-8">
        ...
        <!-- Search Results -->
        <div v-if="searchQuery && searchResults.movies.length > 0" class="mb-8">
          <h3 class="text-white text-2xl font-semibold mb-4">
            Search Results for "{{ searchQuery }}"
          </h3>
          <Movielist :film="searchResults.movies" class="animate-stagger" />
        </div>

        <!-- No Results -->
        <div
          v-else-if="searchQuery && searchResults.movies.length === 0"
        ...
        >
          ...
          <p class="text-lg">No movies found for "{{ searchQuery }}"</p>
...
const search = async () => {
  ...
  searchResults.value = { movies: searchMovies };
};
...
onBeforeMount(async () => {
  ...
  try {
    ...
    error.value = "Failed to load movies. Please refresh the page.";
